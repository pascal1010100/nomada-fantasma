          ...
          <div className="p-6">
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all duration-200 text-left ${
                        selectedType === type.id
                          ? 'border-cyberPurple bg-cyberPurple/5 dark:bg-cyberPurple/10'
                          : 'border-gray-200 dark:border-gray-700 hover:border-cyberPurple/50'
                      }`}
                    >
                      <div className="flex items-center mb-3">
                        ...
                        <h3 className="ml-3 font-medium text-gray-900 dark:text-white">{type.name}</h3>
                      </div>
            ...
            {currentStep === 'details' && (
              <form className="space-y-6">
                <div className="mb-6">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Detalles de tu experiencia</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        {['Hostal', 'Hotel', 'Airbnb', 'Otro'].map((type) => (
                      ...
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-blue-700 dark:text-blue-300">
                            Un experto local se pondrá en contacto contigo en menos de 24 horas para personalizar tu experiencia y confirmar disponibilidad.
                          </p>
                        </div>
                      </div>
                    </div>
