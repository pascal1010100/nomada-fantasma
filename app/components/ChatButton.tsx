...
export default function ChatButton({
  ...
  const panelId = useId(); // para aria-controls
  ...
  // Portal al <body> para que SIEMPRE quede fijo al viewport
  return createPortal(
    <>
      ...
      <motion.button
        ...
        className="
          fixed z-50 h-14 w-14 md:h-16 md:w-16
      ...
      {/* Modal separado */}
      <ChatModal open={open} onClose={() => setOpen(false)} variant={variant} panelId={panelId} />
    </>,
    document.body
  );
}
